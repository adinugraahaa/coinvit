...
<html lang="en">
  ...
  <link rel="stylesheet" href="css/stellar2.css">
...
<ul class="nav nav-pills nav-justified nav-fill" id="pills-tab nav1" role="tablist">
  <li class="nav-item text-dark">
    <a class="nav-link" id="pills-charts-tab" data-toggle="pill" href="#pills-charts" role="tab" aria-controls="pills-charts" aria-selected="true">Charts</a>

  </li>
  <li class="nav-item">
    <a class="nav-link active" id="pills-trade-tab" data-toggle="pill" href="#pills-trade" role="tab" aria-controls="pills-trade" aria-selected="false">Trade</a>
  </li>
  <li class="nav-item">
...
<div class="tab-content" id="pills-tabContent">
  ...
  <!-- modal-lr -->
    ...
    <!-- end modal-lr -->
            ...
            <!-- modal typecoin -->
        <div class="modal fade" id="typecoin" tabindex="-1" role="dialog" arial-labelledby="typecoinlabel" area-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-body">
                    <ul class="nav nav-pills nav-fill" id="pills-tab2" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link " id="pills-favo-tab" data-toggle="pill" href="#pills-favo" role="tab" aria-controls="pills-favo" aria-selected="false">Favorites</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link active" id="pills-btc-tab" data-toggle="pill" href="#pills-btc" role="tab" aria-controls="pills-btc" aria-selected="false">BTC</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" id="pills-eth-tab" data-toggle="pill" href="#pills-eth" role="tab" aria-controls="pills-eth" aria-selected="false">ETH</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item float-left">
                          <a class="nav-link" class="close" data-dismiss="modal" aria-label="Close">
                          <i class="fas fa-angle-down"></i>
                        </a>
                        </li>
                      </ul>
                      <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade" id="pills-favo" role="tabpanel" aria-labelledby="pills-favo-tab">
                            <h4 class="h4">Current: BTC/BNB</h4>
                        </div>
                        <div class="tab-pane fade show active" id="pills-vt" role="tabpanel" aria-labelledby="pills-vt-tab">  
                          <h4 class="h4">Current: BTC/BNB</h4>
                        ...
                        <div class="tab-pane fade" id="pills-eth" role="tabpanel" aria-labelledby="pills-eth-tab">
                        ETH
                      </div>
    ...
    <!-- modal typecoin2 -->
            <div class="modal fade" id="typecoin2" tabindex="-1" role="dialog" arial-labelledby="typecoinlabel" area-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-body">
